      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="course-item">
              ...
              <div class="course-content">
                ...
                <h3><a href="course-details/web-course.php">Website Design</a></h3>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="course-item">
              ...
              <div class="course-content">
                ...
                <h3><a href="course-details/c-course.php">C fundamentals</a></h3>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="course-item">
              <img src="assets/img/new/python.jpg" class="img-fluid" alt="...">
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h4>Content</h4>
                ...
                <h3><a href="course-details/python-course.php">Basics of Python</a></h3>
